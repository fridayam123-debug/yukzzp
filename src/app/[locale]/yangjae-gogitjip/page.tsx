...
export const metadata: Metadata = {
  ...
  description: '양재역 고깃집 추천. 산청 흑돼지·거창 백돼지 특화 프리미엄 고기집. 양재역 3번 출구 도보 2분. 특허 파동숙성, 대나무 숯 직화, 전담 그릴링 서비스.',
  ...
  return (
    <SeoLandingPage
      ...
      meta={{
        ...
        h1: '양재역 고깃집\n육즙관리소 프리미엄 K-BBQ',
        description: '양재역 최고의 고깃집. 지리산 산청 흑돼지와 거창 백돼지를 특허 파동숙성·100% 대나무 숯 직화로 구워내는 서울 프리미엄 고기 전문점. 양재역 3번 출구 도보 2분, 전담 서버 그릴링 서비스.',
        body: [
