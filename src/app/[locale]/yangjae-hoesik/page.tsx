...
export const metadata: Metadata = {
  ...
  description: '양재역 회식 장소 추천. 8인·10인·20인·40인 프라이빗 룸·단체석 운영. 하향식 덕트로 연기 없는 쾌적한 환경. 양재역 3번 출구 도보 약 2~3분.',
  ...
  return (
    <SeoLandingPage
      ...
      meta={{
        ...
        h1: '양재역 회식\n프라이빗 룸 단체 다이닝',
        description: '양재역 최고의 회식 장소. 8인·10인·20인·40인 규모의 프라이빗 룸과 단체석을 운영합니다. 하향식 덕트 시스템으로 옷에 냄새와 연기가 배지 않는 쾌적한 환경에서, 전담 서버의 그릴링 서비스와 함께 품격 있는 회식 자리를 만들어 드립니다. 양재역 3번 출구 도보 약 2~3분.',
        body: [
          '육즙관리소 양재역점은 양재역 3번 출구에서 도보 약 2~3분 거리에 위치한 단체 다이닝 공간입니다. 부서 회식, 송년회·신년회, 임원 만찬, 비즈니스 디너까지 다양한 규모의 단체 모임을 위한 공간을 운영합니다.',
