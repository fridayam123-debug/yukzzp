...
export const metadata: Metadata = {
  ...
  description: '양재역 근처 프리미엄 흑돼지 맛집. 산청 흑돼지·거창 백돼지, 특허 파동숙성, 전담 그릴링 서비스. 양재역 3번 출구 도보 2분. 이원일 셰프 추천 K-BBQ 다이닝.',
  ...
  return (
    <SeoLandingPage
      ...
      meta={{
        ...
        h1: '양재역 맛집\n육즙관리소 프리미엄 K-BBQ',
        description: '양재역 3번 출구 도보 2분. 지리산 산청 흑돼지와 거창 백돼지를 특허 파동숙성과 100% 대나무숯 직화로 제공하는 서울 프리미엄 K-BBQ 다이닝. 이원일 셰프가 직접 추천한 미친듯이 맛있는 돼지고기집.',
        body: [
          '육즙관리소 양재역점은 양재역 3번 출구에서 도보 2분 거리에 위치한 프리미엄 K-BBQ 다이닝입니다. 패션 디자이너 출신 대표가 직접 설계한 공간과 서비스 동선으로, 한 끼의 식사가 하나의 완성된 경험이 됩니다.',
