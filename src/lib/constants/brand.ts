  ...
  pillars: [
    {
      key: 'origin',
      title: '가장 좋은 식재료',
      description: '팔도의 가장 좋은 식재료를 고집합니다. 야생쑥을 먹고 자란 산청 흑돼지·거창 백돼지의 쫄깃한 육질, 뛰어난 향미의 고급 품종 수향미 밥까지 — 모든 식재료에서 차이를 만듭니다.',
    },
    {
      key: 'aging',
      title: '특허 파동숙성',
    ...
    },
    {
      key: 'duct',
      title: '하향식 덕트',
      description: '100% 대나무 숯으로 잡내 없는 깊은 불향을 내고, 하향식 덕트로 연기·냄새를 식탁 아래로 즉시 흡입. 옷에 냄새가 배지 않고 눈이 맵지 않아 데이트·회식·청첩장 자리에서도 깔끔하게 즐길 수 있습니다.',
    },
    {
      key: 'sides',
      title: '직접 담근 정성찬',
