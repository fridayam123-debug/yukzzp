...
> = {
  yangjae: {
    description:
      '육즙관리소 양재역본점은 양재역 3번 출구에서 도보 약 2~3분 거리에 위치한 프리미엄 K-BBQ 다이닝입니다. 산청 흑돼지와 거창 백돼지를 특허 파동숙성하고 100% 대나무숯 직화로 구워 전문 서버가 직접 그릴링해 드립니다. 하향식 덕트로 연기와 냄새를 줄였으며, 8인·10인·20인·40인 프라이빗 룸과 단체석을 갖춰 회식·접대·데이트·가족 외식에 적합한 양재역 맛집입니다.',
    keywords: [
