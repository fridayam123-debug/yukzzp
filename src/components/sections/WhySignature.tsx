...
const PILLARS = [
  { icon: '🏔', title: '가장 좋은 식재료',  description: '육즙관리소는 전국 팔도의 최상급 식재료만을 고집합니다. 야생쑥을 사료화해 건강하게 키운 산청 흑돼지와 거창 백돼지는 깊은 풍미와 쫄깃한 육질을 자랑하며, 뛰어난 향과 찰기를 가진 프리미엄 수향미는 식사의 완성도를 더욱 높여줍니다. 좋은 재료가 맛의 기준을 만든다는 믿음으로, 육즙관리소는 원육부터 쌀, 곁들임 하나까지 가장 좋은 재료만을 선별합니다.' },
  { icon: '⚛',  title: '특허 파동숙성',   description: '파동숙성은 고기의 육질을 더욱 부드럽고 촉촉하게 만들어주는 숙성 방식입니다. 숙성 과정에서 육즙 보존력과 풍미를 높여 깊은 감칠맛과 깔끔한 고기 본연의 맛을 끌어냅니다. 육즙관리소는 좋은 원육에 파동숙성을 더해 더욱 부드럽고 풍미 깊은 고기를 제공합니다.' },
  { icon: '💨', title: '하향식 덕트',      description: '100% 대나무 숯으로 잡내 없는 깊은 불향을 내고, 하향식 덕트로 연기·냄새를 식탁 아래로 즉시 흡입. 옷에 냄새가 배지 않고 눈이 맵지 않아 데이트·회식·청첩장 자리에서도 깔끔하게 즐길 수 있습니다.' },
  { icon: '🫙', title: '직접 담근 정성찬',  description: '매장에서 직접 만드는 반찬과 7가지 소스. 유자청 겉절이 · 계절 장아찌.' },
  { icon: '🔥', title: '전문 그릴링 서비스', description: '전문 서버가 최적의 불 조절로 직접 구워드립니다. 굽기 걱정 없이 대화와 식사에만 집중하실 수 있어 데이트·접대·기념일 자리에 특히 좋습니다.' },
]
