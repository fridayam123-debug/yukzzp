...
const PILLARS = [
  ...
  },
  {
    icon: '饌',
    title: '직접 담근 정성찬',
    description: '육즙관리소는 매장에서 직접 만드는 반찬과 7가지 시그니처 소스로 완성도 높은 다이닝 경험을 제공합니다. 다시마소금부터 표고와사비, 청어알과 가리비 조합까지 각 소스는 고기의 풍미를 더욱 깊게 끌어올리도록 개발되었습니다. 유자청 겉절이와 제철 장아찌 등 계절의 맛을 담은 정성찬은 식사의 균형과 완성도를 높여줍니다. 고기뿐만 아니라 곁들임 하나까지 세심하게 준비하는 것이 육즙관리소의 기준입니다.',
  },
]
