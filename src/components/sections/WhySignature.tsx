...
const PILLARS = [
  { icon: '🏔', title: '가장 좋은 식재료',  description: '팔도의 가장 좋은 식재료를 고집합니다. 야생쑥을 먹고 자란 산청 흑돼지·거창 백돼지의 쫄깃한 육질, 뛰어난 향미의 고급 품종 수향미 밥까지 — 모든 식재료에서 차이를 만듭니다.' },
  ...
  { icon: '🫙', title: '직접 담근 정성찬',  description: '매장에서 직접 만드는 반찬과 소스. 유자청 겉절이 · 계절 장아찌 무한리필.' },
]
