const QA_BLOCKS = [
  ...
  },
  {
    ...
    answer: `육즙관리소 더룸 을지로동대문점은 오전 11시부터 새벽 5시까지 연중무휴로 운영하는 을지로 프리미엄 K-BBQ 다이닝입니다. 동대문DDP·굿모닝시티 쇼핑몰 영업 이후 심야 회식, 을지로 인쇄골목 야간 미팅, IT·스타트업 야근 후 회식 장소로 많이 찾습니다. 4~40인 수용 가능한 프라이빗 룸과 단체석을 갖추고 있으며, 굿모닝시티 지하주차장 1시간 무료 주차권을 제공합니다. 산청 흑돼지 파동숙성 고기를 대나무숯 직화로 구워드리는 전담 서버 서비스가 자정 이후에도 동일하게 운영됩니다. 예약 문의: 0507-1328-6363.`,
  },
] as const
