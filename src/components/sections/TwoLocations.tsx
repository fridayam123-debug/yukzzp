...
const HIGHLIGHT_KO: Record<string, { kicker: string; points: string; subway: string; parking: string; naverPlaceId: string }> = {
  yangjae: { kicker: 'YANGJAE · 양재역본점', points: '콜키지 · 점심특선 · 가족 · 기념일에 어울려요', subway: '양재역 3번 출구 도보 약 2~3분', parking: '근처 공영주차장 또는 SK허브프리모 유료주차장', naverPlaceId: '1672141709' },
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
          {[...locations].sort((a, b) => {
            ...
            const h = highlights[loc.slug] ?? { kicker: loc.slug.toUpperCase(), points: '', subway: '' }
