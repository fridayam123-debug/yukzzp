    ...
    <section className="bg-[var(--color-coral)] py-20 md:py-32 px-6 md:px-24">
      <div className="max-w-[1440px] mx-auto grid md:grid-cols-2 gap-10 items-start">
        <div className="text-[var(--color-canvas)] order-2 md:order-1">
          ...
          <h2 className="text-[32px] md:text-[48px] font-normal mt-5 leading-[1.05] tracking-[-0.01em]" style={{ fontFamily: "'Cafe24Classictype', serif" }}>{h2}</h2>
          <p className="text-[20px] md:text-[26px] mt-3 opacity-95 font-normal leading-[1.3]">{sub}</p>
