  ...
  return (
    <section className="relative h-[80vh] md:h-[720px] overflow-hidden bg-[var(--color-stone)] flex items-end">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto w-full px-6 md:px-24 pb-20 md:pb-32 flex flex-col gap-6">
        ...
        <h1 className="text-[48px] md:text-[80px] font-normal text-white leading-[0.98] tracking-[-0.01em] max-w-[820px] whitespace-pre-line">{t('h1')}</h1>
        <p className="text-[16px] md:text-[18px] text-white/90 leading-relaxed max-w-[560px] mt-2">{t('sub')}</p>
