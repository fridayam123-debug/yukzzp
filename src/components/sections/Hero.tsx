  ...
  return (
    <section className="relative h-screen overflow-hidden bg-[var(--color-stone)] flex items-end">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto w-full px-6 md:px-24 pb-20 md:pb-32 flex flex-col gap-6">
        ...
        <h1 className="text-[36px] md:text-[60px] font-normal text-[var(--color-canvas)] leading-[1.05] tracking-[-0.01em] max-w-[900px] whitespace-pre-line" style={{ fontFamily: "'Cafe24Classictype', serif" }}>{t('h1')}</h1>
        <p className="text-[14.5px] md:text-[15.5px] text-[var(--color-canvas)]/80 leading-[1.9] max-w-[860px] mt-4 whitespace-pre-line tracking-[0.01em]">{t('sub')}</p>
