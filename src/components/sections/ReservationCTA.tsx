  ...
  return (
    <section id="reserve" className="bg-[var(--color-canvas-soft)] py-20 md:py-32 px-6 md:px-24">
      <div className="max-w-[1024px] mx-auto text-center flex flex-col gap-7 items-center">
        ...
        <h2 className="text-[44px] md:text-[56px] font-normal text-[var(--color-ink)] tracking-[-0.01em] leading-[1.05]" style={{ fontFamily: "'Cafe24Classictype', serif" }}>{COPY_KO.reservationH2}</h2>
            ...
            <div key={loc.slug} className="flex flex-col sm:flex-row gap-2">
              {loc.naver_place_id && (
                <a
                  ...
                  className="inline-flex items-center justify-center bg-[#03C75A] text-[var(--color-canvas)] px-7 py-4 rounded-[var(--radius-cta)] text-[14px] font-medium whitespace-nowrap"
                >
              ...
              {loc.catchtable_url && (
                <a
                  ...
                  data-event="reservation_click"
                  data-location={loc.slug}
                  className="inline-flex items-center justify-center bg-[var(--color-forest)] text-[var(--color-canvas)] px-7 py-4 rounded-[var(--radius-cta)] text-[14px] font-medium whitespace-nowrap"
                >
